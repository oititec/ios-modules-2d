...
## [versão 1.2.0](https://github.com/oititec/ios-liveness-2d/releases/tag/1.2.0)
_data: 29/09/2023_

- **Melhorias**
    - Adicionado um novo objeto de customização (_opcional_) para DocCore no inicializador da classe `DocumentscopyViewController`.

## [versão 1.1.0](https://github.com/oititec/ios-liveness-2d/releases/tag/1.1.0)
_data: 08/08/2023_
...
## [versão 1.0.0](https://github.com/oititec/ios-liveness-2d/releases/tag/1.0.0)
_data: 07/07/2023_
